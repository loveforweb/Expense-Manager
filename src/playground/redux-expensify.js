...
const expOne = store.dispatch(addExpense({ description: 'rent', amount: 55500, createdAt: -21000 }));
const expTwo = store.dispatch(addExpense({ description: 'coffee', amount: 100, createdAt: -1000 }));
